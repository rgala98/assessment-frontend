...
export function filterMatrixByDifficulty(matrix, diff) {
  ...
  switch (diff) {
    case "easy":
      tilesToClear = Math.floor(tilesToClear * 0.22);
      break;
    case "medium":
      tilesToClear = Math.floor(tilesToClear * 0.44);
      break;
    case "hard":
      tilesToClear = Math.floor(tilesToClear * 0.66);
      break;
    case "expert":
      tilesToClear = Math.floor(tilesToClear * 0.88);
      break;
    default:
      break;
  }
